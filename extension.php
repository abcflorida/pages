...
return [
	...
	*/
	...
	'description' => 'extend from platformpages',
	...
	*/
	...
	'providers' => [
             'Abcflorida\Pages\Providers\BcpagesServiceProvider',
	],
	...
	*/
	...
	'routes' => function (ExtensionInterface $extension, Application $app) {
        ...
        if (! $app->routesAreCached()) {
            Route::group(['namespace' => 'Abcflorida\Pages\Controllers'], function () use ($app) {
                Route::group([
                    'prefix'    => admin_uri().'/bcpages',
                    'namespace' => 'Admin'
                ], function () {
                    Route::get('/', ['as' => 'admin.pages.all', 'uses' => 'BcpagesController@index']);
                    Route::post('/', ['as' => 'admin.pages.all', 'uses' => 'BcpagesController@executeAction']);

                    Route::get('grid', ['as' => 'admin.pages.grid', 'uses' => 'BcpagesController@grid']);

                    Route::get('create', ['as' => 'admin.pages.create', 'uses' => 'BcpagesController@create']);
                    Route::post('create', ['as' => 'admin.pages.create', 'uses' => 'BcpagesController@store']);

                    Route::get('{id}', ['as' => 'admin.pages.edit', 'uses' => 'BcpagesController@edit']);
                    Route::post('{id}', ['as' => 'admin.pages.edit', 'uses' => 'BcpagesController@update']);
                    Route::delete('{id}', ['as' => 'admin.pages.delete', 'uses' => 'BcpagesController@delete']);

                    Route::get('{id}/copy', ['as' => 'admin.pages.copy', 'uses' => 'BcpagesController@copy']);
                    Route::post('{id}/copy', ['as' => 'admin.pages.copy', 'uses' => 'BcpagesController@store']);
                });

                foreach ($app['acflorida.bcpages']->findAllEnabled() as $page) {
                    Route::get($page->uri, 'Frontend\BcpagesController@page');
                }
            });
        }
    },
	...
	*/
	...
	'settings' => function(Settings $settings, Application $app)
	{
            ...
            //dd( $settings );
            $settings->find('platform')->section('bcpages', function ($section) {
                
                $section->name = 'bcpages';
                
                $section->fieldset('general', function ($fieldset) {
                
                    $fieldset->name = 'General';

                    $fieldset->field('default_page', function ($field) {
                        $field->name = 'Test Entry';
                        $field->config = 'abcflorida-pages.testvariable';
                        $field->name = 'Test Confi value';
	...
	*/
	...
	'menus' => [
		...
		'admin' => [
			...
			[
				'slug'  => 'admin-abcflorida-pages',
				'name'  => 'Pages',
				'class' => 'fa fa-circle-o',
				'uri'   => 'pages',
				'regex' => '/:admin\/bcpages/i',
			],
